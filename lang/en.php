...
define('_about_part8' , 'Equipation Investment Company Limited was established in 2021 AD as a promising Sudanese company in the field of mining services, providing a comprehensive and integrated set of services in this sector. The company began its journey by leasing and operating heavy equipment and machinery, and was soon able to expand the scope of its work to include mining contracting and establishing, managing and operating Mines in mining projects. Economy is considered one of the few companies that provides transportation services within the scope of its work, especially for long distances, and is distinguished by high quality and efficiency <span id="dots"> ... </span> <span id="more"> in providing these services.In addition, it provides maintenance services for heavy equipment and machinery, ensuring that the highest levels of performance and sustainability are maintained for the company’s assets and those of its customers. It also relies on a specialized and advancedly trained work team, and always aims to provide specialized human resources that meet production and industry requirements and achieve customer goals with high efficiency. In addition, the company provides services for providing, installing and monitoring tracking systems, which is an essential aspect that contributes to enhancing the efficiency of production operations and ensuring control and safety in projects.</span> <button id="link" style="color:orange;background-color:#666" onclick="fun_readmore();"> more... </button>');
...
define('_our_story_part3' , 'The story of the establishment of Economy Investment Limited; It reflects an ambitious and inspiring journey in the mining sector in Sudan. Ten years ago, the journey began with a renewed vision to provide support and provide the necessary services for productive projects in light of the weak infrastructure and lack of services available in this sector. Since 2014, the company has taken a steady path towards providing heavy equipment.And implementing foundational and operational projects to support individuals and companies in <span id="dots2"> ... </span> <span id="more2"> the mining sector. Geographic barriers, environmental difficulties, or arduous work challenges did not stop; Their desire to contribute to the extraction of minerals as a basic economic resource for the country, and at the beginning of the year 2021 AD, the next stage came to consolidate this vision in its developed form with the establishment of Economy Investment Company Limited, to open a new developed page by providing the latest and most appropriate equipment, the best staff and the finest systems, armed with the finest ethics.</span><button id="link2" style="color:orange;background-color:#666" onclick="fun_readmore2();"> more... </button>');
